...
#       GitTool v1.0 
#  
#             GitTool Create By : LooyFarahi001 
#             Telegram Channel :farah_Hack
...
echo ""
echo -e $cyan"    Create by           $white":" $red Looy  "
echo -e $cyan"    Telegram Channel     $white":" $red T.me/Farah_Hack"
...
echo -e $okegreen"   ====================== Tool Lest =======================    ";
        ...
        case "$option" in 
           ...
           14)  echo "fluxion"
                ...
                clear
                ;;
            q)  echo -e $yellow " Thanks For Using My Tools Good Bye  {Farahi}  !!"
                echo
                exit 0 
                ;;
        esac
